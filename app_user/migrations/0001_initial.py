# Generated by Django 3.2.16 on 2023-01-24 19:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='What is the title for your project?', max_length=255)),
                ('description', models.TextField(blank=True, help_text='Enter your project description here', null=True)),
                ('p_language', models.ManyToManyField(to='app_user.ProgrammingLanguage')),
        ...
        migrations.AddField(
            model_name='user',
            name='p_language',
            field=models.ManyToManyField(to='app_user.ProgrammingLanguage'),
        ),
        migrations.AddField(
            model_name='user',
